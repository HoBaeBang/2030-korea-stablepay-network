...
오늘의 실습은 `docs/domain/phase-2-study-summary.md`를 직접 작성하고, Phase 2 첫 구현 범위와 Sprint 2 백로그 후보를 정리하는 것입니다.
...
`docs/domain/phase-2-study-summary.md` 파일을 직접 채우고, 다음 내용을 정리합니다.
...
```shell
docs/domain/phase-2-study-summary.md
```
...
```shell
git add docs/domain/phase-2-study-summary.md
