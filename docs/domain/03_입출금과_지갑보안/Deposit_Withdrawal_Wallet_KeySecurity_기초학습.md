...
Day 3의 목표는 입금, 출금, 지갑, 키 보안이 왜 일반 CRUD와 다르게 다뤄져야 하는지 이해하고, 퇴근 후 직접 `docs/domain/03_입출금과_지갑보안/Wallet_Deposit_Withdrawal_실습산출물.md`를 작성할 준비를 하는 것입니다.
...
| 순서 | 문서 | 목적 |
| --- | --- | --- |
| 1 | [Deposit, Withdrawal, Wallet, Key Security 개념 학습](Deposit_Withdrawal_Wallet_KeySecurity_개념학습.md) | 출퇴근 시간에 읽을 핵심 개념 자료 |
| 2 | [Wallet, Deposit, Withdrawal 실습 가이드](Wallet_Deposit_Withdrawal_실습가이드.md) | 퇴근 후 직접 작성할 문서 가이드 |
| 3 | [Deposit, Withdrawal, Wallet, Key Security 검증문제와 답변가이드](Deposit_Withdrawal_Wallet_KeySecurity_검증문제_답변가이드.md) | 학습 후 스스로 확인할 문제와 답변 기준 |
...
1. GitHub repo에서 `docs/domain/03_입출금과_지갑보안/Wallet_Deposit_Withdrawal_실습산출물.md` 파일을 만든다.
...
- [Ledger and Settlement](../02_원장과_정산/Ledger와_Settlement_실습산출물.md)
