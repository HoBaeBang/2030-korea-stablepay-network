...
| 구분 | 문서 |
| --- | --- |
| Day 1 | [Phase 2 Domain Map](phase-2-domain-map.md) |
| Day 2 | [Ledger와 Settlement 개념 학습](ledger-and-settlement-concepts.md) |
| Day 3 | [Deposit, Withdrawal, Wallet, Key Security 개념 학습](deposit-withdrawal-wallet-key-security-concepts.md) |
| Day 4 | [Blockchain Event Indexer 개념 학습](blockchain-event-indexer-concepts.md) |
| Day 5 | [Phase 2 첫 구현 범위 결정 개념 학습](phase-2-implementation-scope-concepts.md) |
| Day 6 | [Phase 2 통합 복습 개념 학습](phase-2-review-checkpoint-concepts.md) |
