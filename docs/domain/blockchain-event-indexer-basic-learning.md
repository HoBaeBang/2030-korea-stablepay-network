...
| 순서 | 문서 | 목적 |
| --- | --- | --- |
| 1 | [Blockchain Event Indexer 개념 학습](blockchain-event-indexer-concepts.md) | 출퇴근 시간에 읽을 핵심 개념 자료 |
| 2 | [Blockchain Event Indexer 실습 가이드](blockchain-event-indexer-practice-guide.md) | 퇴근 후 직접 작성할 문서 가이드 |
| 3 | [Blockchain Event Indexer 검증문제와 답변가이드](blockchain-event-indexer-verification-guide.md) | 학습 후 스스로 확인할 문제와 답변 기준 |
...
1. GitHub repo에서 `docs/domain/blockchain-event-indexer.md` 파일을 만든다.
