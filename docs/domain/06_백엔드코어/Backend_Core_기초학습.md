...
| 순서 | 문서 | 언제 보는가 | 목적 |
| --- | --- | --- | --- |
| 1 | [Backend Core 개념 학습](Backend_Core_개념학습.md) | 출퇴근 학습 | Backend Core의 역할과 구현 후보를 이해한다. |
| 2 | [Backend Core 실습 가이드](Backend_Core_실습가이드.md) | 퇴근 후 작업 전 | 실습산출물에 무엇을 작성해야 하는지 확인한다. |
| 3 | [Backend Core 실습산출물](Backend_Core_실습산출물.md) | 퇴근 후 작업 | Sprint 2 구현 전 백엔드 코어 설계 초안을 작성한다. |
| 4 | [Backend Core 검증문제와 답변가이드](Backend_Core_검증문제_답변가이드.md) | 산출물 작성 후 | 이해한 내용을 문제로 점검한다. |
